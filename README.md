...
Ceci est un projet de lycéen qui vise a crée un jeux 3D
nous sommes des débutant avec plus ou moins d'experience 

# raccourcis et astruce

comme tout **les jeux en général** vous pouvez mouvoir avec les touches ```Z Q S D```
...
* ajout des texture et nouveau models 3D  
* ajout du montre
* correction de bugs
